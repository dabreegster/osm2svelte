<script lang="ts">
  ...
  import BuiltInSelector from "osm2streets-web/src/osm2streets-svelte/osm_input/BuiltInSelector.svelte";
  import OverpassSelector from "osm2streets-web/src/osm2streets-svelte/osm_input/OverpassSelector.svelte";
  import type { OsmSelection } from "osm2streets-web/src/osm2streets-svelte/osm_input/types";
